      ...
      const mid = async (totalCorrect) => {
        ...
        try {
          ...
          if (finalScore >= 0 && finalScore < 2) {
            Imagine = await client.Imagine("Minimalist retro poster style. A single small ball form growing inside a petri dish, abstract yet structured, resembling flowing coral, soft petals, or intricate cellular growth. Smooth, fluid textures with delicate folds and bioluminescent red-violet hues. Avoids bacterial or viral appearance. Sharp, clean edges, no blur. Dark background for contrast. Flat colors, subtle grain, and vintage-inspired tones Minimalist --sref 1152995874", (uri, progress) => { });
          } else if (finalScore < 4) {
            Imagine = await client.Imagine("Minimalist retro poster style. A single small ball form growing inside a petri dish, abstract yet structured, resembling flowing coral, soft petals, or intricate cellular growth. Smooth, fluid textures with delicate folds and bioluminescent red-violet hues. Avoids bacterial or viral appearance. Sharp, clean edges, no blur. Dark background for contrast. Flat colors, subtle grain, and vintage-inspired tones Minimalist --sref 2735915676", (uri, progress) => { });
          } else {
            Imagine = await client.Imagine("Minimalist retro poster style. A single small ball form growing inside a petri dish, abstract yet structured, resembling flowing coral, soft petals, or intricate cellular growth. Smooth, fluid textures with delicate folds and bioluminescent red-violet hues. Avoids bacterial or viral appearance. Sharp, clean edges, no blur. Dark background for contrast. Flat colors, subtle grain, and vintage-inspired tones Minimalist --sref 4248842730", (uri, progress) => { });
          }
